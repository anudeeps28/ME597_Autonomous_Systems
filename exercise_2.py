...
def position_node():
    ...
    while not rospy.is_shutdown():
        ...
        while state_msg.pose.position.x < 1: # changing robot's x-coordinate position from 0 to 1.
            state_msg.pose.position.x += 0.05 # giving step size of 0.05
            state_msg.pose.position.y = 0 # y-coordinate stays 0
